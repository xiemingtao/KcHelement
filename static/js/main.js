...
function s(e) {
  ...
  e.MapConfig = {
    ...
    _MAP_PC_DATAS_URL: ["http://hs1.ishowchina.com/v3/hotspot/", "http://hs2.ishowchina.com/v3/hotspot/",
      "http://hs3.ishowchina.com/v3/hotspot/"],
    _CONTROL_COPYRIGHT: "",
  ...
  e.Function = {
    ...
    unSelect: function (a) {
      "WebkitUserSelect" in document.documentElement.style ? (a.style.WebkitUserSelect = "text", a.style.onselectstart =
        "return true;") : "MozUserSelect" in document.documentElement.style ? a.style.MozUserSelect = "text" :
          "OUserSelect" in document.documentElement.style ? a.style.ib = "text" : "msUserSelect" in document.documentElement
            .style ? a.style.Ja = "text" : (a.unselectable = "on", a.style.Ja = "text", a.onselectstart =
              "return true;")
    },
    pageSize: function (a) {
    ...
    calculatePedal: function (a, b) {
      for (var c = null, d = null, f = null, c = null, g = -1, h = d = -1, k = 1, m = a.length; k < m; k++) {
        if (c = a[k - 1], d = a[k], c = e.Function.oa(b, c, d), null != c && (d = e.Function.ma(b, c), -1 == g ||
          d < g)) {
          g = d, f = c, h = k
        }
      }
    ...
    oa: function (a, b, c) {
      ...
      if (90 < d || 90 < e.Function.Z(e.Function.H(c.lng, c.lat, a.lng, a.lat), e.Function.H(c.lng, c.lat, b.lng,
        b.lat))) {
        return null
      }
    ...
    pagePosition: function (a) {
      ...
      if (a.getBoundingClientRect) {
        a = a.getBoundingClientRect(), d = window.pageYOffset || c.scrollTop, b[0] = a.left + (window.pageXOffset ||
          c.scrollLeft), b[1] = a.top + d
      } else {
        if (document.getBoxObjectFor && !d) {
          a = document.getBoxObjectFor(a), c = document.getBoxObjectFor(c), b[0] = a.screenX - c.screenX, b[1] =
            a.screenY - c.screenY
        } else {
          b[0] = a.offsetLeft;
          b[1] = a.offsetTop;
    ...
    getStyle: function (a, b) {
      ...
      if (a && a.style) {
        ...
        c || (document.defaultView && document.defaultView.getComputedStyle ? c = (c = document.defaultView.getComputedStyle(
          a, null)) ? c.getPropertyValue(b) : null : a.currentStyle && (c = a.currentStyle[this.$(b)]));
  ...
  e.Function.vendorPrefix = function () {
    ...
    function b(a, b) {
      if (void 0 === h[b]) {
        ...
        for (h[b] = null; e < f; e++) {
          if ((c = d[e]) ? (g || (c = c.toLowerCase()), c = c + b.charAt(0).toUpperCase() + b.slice(1)) : c =
            b, void 0 !== a[c]) {
            h[b] = c;
            break
          }
  ...
  e.Class = function () {
    ...
    for (var b = {}, c, d = 0, f = arguments.length; d < f; ++d) {
      "function" == typeof arguments[d] ? (0 == d && 1 < f && (c = arguments[d].prototype.initialize, arguments[d]
        .prototype.initialize = l(), b = new arguments[d], void 0 === c ? delete arguments[d].prototype.initialize :
          arguments[d].prototype.initialize = c), c = arguments[d].prototype) : c = arguments[d], e.Function.extend(
            b, c)
    }
    a.prototype = b;
    return a
  ...
  e.Browser = {
    ...
    isSafari: function () {
      return /webkit/i.test(this.j()) && !(/chrome/i.test(this.j()) && /webkit/i.test(this.j()) && /mozilla/i.test(
        this.j()))
    },
    isFirefox: function () {
    ...
    setOpacity: function (a) {
      if (!isNaN(a)) {
        ...
        for (var b = 0, c = this.B.childNodes.length; b < c; b++) {
          e.Browser.isIE7() || e.Browser.isIE8() ? this.B.childNodes[b].style.filter =
            "progid:DXImageTransform.Microsoft.Alpha(opacity=" + 100 * a + ")" : this.B.childNodes[b].style
              .opacity = a
        }
      }
    },
  ...
  e.InfoWindow = e.Class(e.Overlay, {
    ...
    F: function (a) {
      a instanceof e.Map ? (this.a = a, this.I = a.getOverlayLayer(), this.f._source = this.a.mapObj, this.a.mapObj
        .openPopup(this.f, this.b.position), this.G(), this.setAnchor(this.b.anchor)) : (this.T(), this.a =
          this.I = null)
    },
    ca: function () {
  ...
  e.Marker = e.Class(e.Overlay, {
    initialize: function (a, b) {
      ...
      switch (parseInt(c.pointType)) {
        ...
        case 2:
        case 3:
          c.pointWidth = 0 == parseInt(c.pointWidth) ? 22 : c.pointWidth, c.pointHeight = 0 == parseInt(c.pointHeight) ?
            22 : c.pointHeight
      }
    ...
    moveTo: function (a, b, c) {
      ...
      if (0 == p) {
        ...
        d.s = e.Function.createInterval(function () {
          ...
          d.f.update();
          g >= p && (d.b.position = a, d.setPosition(d.b.position), d.f.update(), e.Function.clearInterval(d.s),
            d.s = null, d.f.fire("moveend", {
              latlng: n,
              containerPoint: r,
              layerPoint: t
            }))
    ...
    moveAlong: function (a, b, c, d) {
      var f = this,
        g = f.a,
        h = 1;
      f.D[0] ? f.D[1] ? (h = f.D[0], f.b.position = f.D[1], f.setPosition(f.b.position)) : (f.b.position = a[0],
        f.setPosition(f.b.position), f.D[0] = h) : (f.setPosition(a[0]), f.D[0] = h);
      f.L && (f.removeEventListener(f.L), f.L = null);
      f.L = f.addEventListener(e.Constants.MOVE_END, function () {
        h++;
        h < a.length ? (f.moveTo(a[h], b, d), f.D[0] = h) : c ? (h = 1, f.D[0] = h, f.setPosition(a[0]), f.moveTo(
          a[h], b, d)) : (f.removeEventListener(f.L), f.L = null, f.removeEventListener(f.Ha), f.Ha = null)
      }, f);
    ...
    openInfoWindow: function (a, b) {
      this.K || (b.position = this.b.position, this.K = new e.InfoWindow(a, b), this.K.a = this.a, this.f.bindPopup(
        this.K.f).getPopup().options.anchor = e.Constants.BOTTOM_CENTER);
      ...
      if (!isNaN(a)) {
        ...
        if (b) {
          if (e.Function.transform()) {
            ...
            e.Browser.isIE() && (c = Math.cos(a * Math.PI / 180), a = Math.sin(a * Math.PI / 180), b.style.filter =
              "progid:DXImageTransform.Microsoft.Matrix(" + this.sizingMethod + ",M11=" + c + ",M12=" + -
              a + ",M21=" + a + ",M22=" + c + ")")
          }
        }
      }
    ...
    F: function (a) {
      a instanceof e.Map ? (this.a = a, this.I = a.getOverlayLayer(), a.mapObj.addLayer(this.f), this.G()) : (
        this.T(), this.a = this.I = null)
    },
    ca: function () {
      this.removeLabel();
  ...
  e.Label = e.Class(e.Overlay, {
    ...
    F: function (a) {
      a instanceof e.Map ? (this.a = a, this.I = a.getOverlayLayer(), a.mapObj.addLayer(this.f), this.G(), a =
        this.f.getLabelSize(), this.Ua = new e.Size(a[0], a[1]), this.setAnchor(this.b.anchor)) : (this.T(),
          this.a = this.I = null)
    },
    ca: function () {
      this.f && this.a && this.a.mapObj.removeLayer(this.f)
  ...
  e.PointCollection = e.Class({
    ...
    mb: function (a) {
      ...
      d.addEventListener(e.Constants.MOUSE_MOVE, function (a) {
        ...
        for (var d = c.Gb, b = b.size + 5, k = 0; k < d.length; k++) {
          ...
          k + 1 == d.length && (this.style.cursor = "url(" + (e.MapConfig.API_REALM_NAME + e.MapConfig._MAP_HAND[
            0]) + "), auto", c.S = null)
        }
      });
      ...
      if (!0 !== a) {
        ...
        if (a && b) {
          ...
          for (var d = [], h = 0, k = c.length; h < k; ++h) {
            g = c[h], g = a.lnglatToPixel(g.lnglat), g = new e.Pixel(g.x - b, g.y - f), d.push(g), this.sb(
              g.x, g.y)
          }
          this.Gb = d;
    ...
    sb: function (a, b) {
      ...
      if (!c.t) {
        ...
        if (d.icon) {
          ...
          switch (c.t.Ia = !1, g.width = g.height = k, h.fillStyle = d.fillColor, h.globalAlpha = "number" ==
    ...
    F: function (a) {
      a instanceof e.Map ? (this.a = a, this.I = a.getOverlayLayer(), this.rb()) : (this.T(), this.na = this.h =
        this.a = this.S = this.I = null)
    },
    T: function () {
      var a = this.a;
      a && (a.removeEventListener(this.va), a.removeEventListener(this.Aa), a.removeEventListener(this.ya), a.removeEventListener(
        this.za), a.removeEventListener(this.wa), a.removeEventListener(this.xa), this.xa = this.wa = this.za =
        this.ya = this.Aa = this.va = null);
      this.ca();
      this.a = null
    },
    ca: function () {
  ...
  IMAPVector = e.Class({
    ...
    F: function (a) {
      a instanceof e.Map ? (this.a = a, this._overlayLayer = a.getOverlayLayer(), this._draw()) : (this._destroy(),
        delete this._render, delete this._renderRoot, delete this._overlayLayer, delete this.a)
    },
    X: l(),
    _draw: l(),
    _destroy: function () {
    ...
    N: function () {
      this.d.editing && (this.d.editing.disable(), this.d.off("click", this.Ma, this.d), this.d.off("dragstart",
        this.Sa, this.d), this.a.removeEventListener(this.Ba), this.Ba = null)
    },
    Ma: function (a) {
  ...
  e.Polyline = e.Class(IMAPVector, {
    ...
    _calculateBounds: function (a) {
      ...
      for (var c = b.southwest, d = b.northeast, f = 1, g = a.length; f < g; ++f) {
        c.lng = Math.min(c.lng, a[f].lng), c.lat = Math.min(c.lat, a[f].lat), d.lng = Math.max(d.lng, a[f].lng),
    ...
    setPath: function (a) {
      if (a) {
        var b = e.Function.indexOf(a, -1, "lng"),
          c = e.Function.indexOf(a, -1, "lat"); - 1 == b && -1 == c && (this._path = a, this._calculateBounds(
            a), this.d && (a = this.Q(a), this.d.setLatLngs(a), this.N(), this.editable(this._options.editabled)))
      }
    },
    getPath: function () {
  ...
  e.Rectangle = e.Class(IMAPVector, {
    ...
    setBounds: function (a) {
      a instanceof e.LngLatBounds && (this._bounds = a, this.d && (this.d.setBounds(this.Q(this._bounds)), this.N(),
        this.editable(this._options.editabled)))
    },
    getBounds: function () {
      if (this.d) {
  ...
  e.Circle = e.Class(IMAPVector, {
    initialize: function (a, b, c) {
      ...
      }, a.strokeOpacity = Math.min(Math.max(c.strokeOpacity && !isNaN(c.strokeOpacity) ? c.strokeOpacity : 1, 0),
        1), a.fillOpacity = Math.min(Math.max(isNaN(c.fillOpacity) ? 0.6 : c.fillOpacity, 0), 1), a.strokeWeight =
    ...
    getBounds: function () {
      if (this.a) {
        var a = this.d.getBounds();
        return new e.LngLatBounds(new e.LngLat(a.southwest.lng, a.southwest.lat), new e.LngLat(a.northeast.lng,
          a.northeast.lat))
      }
  ...
  e.Sector = e.Class(IMAPVector, {
    initialize: function (a, b, c, d) {
      if (a instanceof e.LngLat && !isNaN(b)) {
        ...
        f.strokeOpacity = Math.min(Math.max(d.strokeOpacity && !isNaN(d.strokeOpacity) ? d.strokeOpacity : 1, 0),
          1);
    ...
    F: function (a) {
      a ? (this.a = a, a.mapObj.addLayer(this.d), this.G(this.d)) : (this.a && this.d && this.a.mapObj.removeLayer(
        this.d), this.d = this.a = null)
    },
  ...
  e.OverlayLayer = e.Class(e.Layer, {
    ...
    setMap: function (a) {
      a instanceof e.Map ? (this.a = a, this.B || (this.B = this.a.mapObj.getPanes().overlayPane)) : (this.destroy(!
        0), this.a = null)
    },
    getRenderRoot: s("Fa"),
    getRender: s("Ea"),
    ...
    addOverlay: function (a, b) {
      var c = this.a;
      if (c && !this.A[a.getId()] && (a instanceof e.Overlay || a instanceof IMAPVector || a instanceof e.PointCollection ||
        a instanceof e.HeatmapOverlay)) {
    ...
    removeOverlay: function (a) {
      ...
      if (a) {
        if (a instanceof e.Overlay || a instanceof IMAPVector || a instanceof e.PointCollection || a instanceof e
          .HeatmapOverlay) {
  ...
  e.TileLayer = e.Class(e.Layer, {
    ...
    mc: s("l"),
    setMap: function (a) {
      a instanceof e.Map ? (a.mapObj.addLayer(this.l), this._options.hotspotOptions && (this.p = e.HotspotManager
        .getEntity(a), this.p.injectLayer(this.getId(), this._options.hotspotOptions, this.g ? this.g.slice() :
          null)), this.a = a) : (this.a.mapObj.removeLayer(this.l), this.hotspot(!1), this.a = this.l = null)
    },
    hotspot: function (a, b) {
      a && (b || this._options.hotspotOptions) ? (b && (this._options.hotspotOptions = b), this.cb(!0)) : !a &&
        this.p && (this.cb(!1), delete this.p)
    },
    cb: function (a) {
      a ? (this.p || (this.p = e.HotspotManager.getEntity(this.a)), this.g = this.g || [], this.p.injectLayer(
        this.getId(), this._options.hotspotOptions, this.g ? this.g.slice() : null)) : !a && this.p && this.p.removeTileLayer(
          this.getId())
    },
  ...
  e.HotspotEntity = e.Class({
    ...
    Tb: function (a, b, c, d, f, g, h, k) {
      ...
      p.register("loaded", function (n) {
        m.C[h] && (n = d.formatDatas(n), n._xy = a + "." + b, 0 < n.length ? (m.C[h][a + "_" + b + "_" + c] = n,
          m.Ra(f, g, h, n)) : m.C[h][a + "_" + b + "_" + c] = n, e.Function.deleteFromArray(m.fa, k))
      }, m);
      p.load({
  ...
  e.Map = e.Class(e.Events, {
    initialize: function (a, b) {
      ...
      if (b.limitBounds instanceof Array) {
        ...
        b.limitBounds instanceof e.LngLatBounds ? (d.limitBounds = b.limitBounds, g = d.limitBounds.getSouthWest(),
          h = d.limitBounds.getNorthEast(), f[0] = [g.lat, g.lng], f[1] = [h.lat, h.lng]) : (d.limitBounds = [
            new e.LngLat(73, 5), new e.LngLat(140, 55)], f = [
              [5, 73],
              [55, 140]
            ])
      }
    ...
    setMaxLimit: function (a) {
      ...
      if (a instanceof Array) {
        ...
        a instanceof e.LngLatBounds ? (c = a.getSouthWest(), d = a.getNorthEast(), b[0] = [c.lat, c.lng], b[1] = [
          d.lat, d.lng]) : b = null
      }
    ...
    M: function (a, b, c, d) {
      return function (f) {
        ...
        f.latlng && (g.lnglat = new e.LngLat(f.latlng.lng, f.latlng.lat), g.pixel = new e.Pixel(f.layerPoint.x,
          f.layerPoint.y), g.containerPixel = new e.Pixel(f.containerPoint.x, f.containerPoint.y));
        return a.call(b, g)
      }
    },
    removeEventListener: function (a) {
      a && (this.Pa[a.type] ? e.Events.prototype.removeEventListener.apply(this, [a]) : this.mapObj.off(a.type, a
        .func))
    },
    getOptions: s("_options"),
    Ab: function (a) {
  ...
  e.MenuItem = e.Class(e.DOMEvents, {
    ...
    initialize: function (a, b) {
      ...
      var f = e.Function.createElement({
        name: "div",
        cssText: (d.enabled ? c.Qb : c.Rb) + "width:" + d.width + "px;height:" + c.ha + "px;line-height:" + c.ha + "px;cursor:" +
          (d.enabled ? "pointer;" : "default;")
      });
      c.h = f;
      a && (a = e.Function.checkFieldLength(a, 100), c.Xa(a), d.iconUrl && (a =
        ...
        "px; width:" + d.iconSize[0] + 'px;"/></td><td > ' + a + "</td></tr></tbody></table>"), c.u = a, f
          .innerHTML = a);
    ...
    enabled: function (a) {
      "boolean" == typeof a && (this.options.enabled = a, this.h.style.cursor = a ? "pointer" : "default", this.h
  ...
  e.ContextMenu = e.Class(e.Events, e.DOMEvents, {
    ...
    Pb: "-moz-user-select: text;position: absolute;border:1px solid #CCCCCC;padding:1px 1px 1px 1px;color:#000000;background-color:#ffffff;font-size:12px;display:none;z-index:1001; height:auto;border-radius: 3px 3px 3px 3px;font-size:12px;",
    initialize: function (a) {
      this.v = [];
    ...
    removeItem: function (a) {
      if (!isNaN(a)) {
        a = parseInt(a - 1);
        var b = this.v[a];
        b && (this.$a(b.getElement()), this._element.removeChild(b.getElement()), b.isSeparator && b.separatorElement &&
          this._element.removeChild(b.separatorElement), this.v.splice(a, 1), 0 == a && (this._showLocation = !
    ...
    setMap: function (a) {
      !this._map && a && a instanceof e.Map ? (this._map = a, this.lb()) : !a && this._map && (this.Kb(), this._map =
        null)
    },
    _resetMenuItems: function () {
      ...
      if (a) {
        ...
        for (var d = 0, f = c.length; d < f; ++d) {
          if (b = c[d], b.options.callback && (b._close = e.Function.bind(this._close, this)), a.appendChild(
            c[d].getElement()), b.isSeparator) {
            var g = this.yb();
            b.injectSeparator(g);
            a.appendChild(g)
          }
...
(function () {
  ...
  IMAP.Map.prototype.setFitView = function (c) {
    ...
    function h(a) {
      try {
        d = a.lng < d ? a.lng : d, e = a.lat < e ? a.lat : e, f = a.lng > f ? a.lng : f, g = a.lat > g ? a.lat :
          g
      } catch (b) {
    ...
    for (k in c) {
      ...
      if ("marker" == a.type) h(a.getPosition());
        ...
        h(a);
        h(b)
      } else if ((b = a._path) && 0 < b.length) for (a = 0; a < b.length; a++) h(b[a])
    }
...
function banBackSpace (e) {
  ...
  if (ev.keyCode == 8) {
    ...
    if ((tagName == 'INPUT' || tagName == 'TEXTAREA') && (obj.readOnly == true || obj.disable == true)) {
      return stopIt(ev)
    }
  }
}
