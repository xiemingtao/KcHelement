...
var demoHash = [
  ...
  'core/getmapzoom',
  'layer/customlayer',
  'layer/trafficeLayers',
  'point/iconmarker',
  'point/vectormarker',
  'point/markers',
  'point/removespecifiedmarker',
  'point/trackplayback',
  'point/cluster',
  'point/heatmap',
  'point/mass',
  ...
  'mouseMap/getlnglat',
  'mouseMap/drawoverlay',
  'mouseMap/zoomtool',
  'mouseMap/measure',
  'panorama/panoramaControl',
  'event/mapclick',
  'event/overlayevent',
  'event/removemapclick',
  'server/searchkey',
  'layer/traffic',
  'layer/ningbo22',
  'layer/ningbo23',
  ...
  'geocode/geocode',
  'geocode/regeocode',
  'driver/driverforlnglat',
  'walking/walkingforlnglat',
  'bus/busnavi',
  'boundary/boundary',
  'bus/busInfoByName',
  'roadlevel/roadlevel',
  'roadlevel/searchreal',
  'layer/mapTM'
]


var defaultHtmlHash = '#core/map'
...
var getAngle = function (xy1, xy2) {
  ...
  var x1 = Math.abs(xy1['lat']),
    y1 = Math.abs(xy1['lng'])
  var x2 = Math.abs(xy2['lat']),
    y2 = Math.abs(xy2['lng'])
