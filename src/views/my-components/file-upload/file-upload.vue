  ...
  <div>
    <Row>
      <Col span="8">
        <Card>
          <p slot="title">
            <Icon type="ios-cloud-upload-outline"></Icon> 基本上传功能
          </p>
      ...
      <Col span="8" class="padding-left-10">
        <Card>
          <p slot="title">
            <Icon type="ios-copy-outline"></Icon> 可多选的上传
          </p>
          <div class="height-120px">
            <Row type="flex" justify="center" align="middle" class="height-100">
    ...
    <div class="margin-top-10">
      <Col span="8">
        <div>
          <Card>
            <p slot="title">
              <Icon type="android-funnel"></Icon> 可监听上传各个阶段
            </p>
        ...
        <div class="margin-top-10">
          <Card>
            <p slot="title">
              <Icon type="android-hand"></Icon> 可拖拽上传
            </p>
            <div class="height-200px">
              <Upload
                multiple
